...
{		
	...
	GPIO_InitStructure.GPIO_Pin = FRONT_LEFT_F_PIN | FRONT_LEFT_B_PIN | FRONT_RIGHT_F_PIN | FRONT_RIGHT_B_PIN | BEHIND_LEFT_F_PIN | BEHIND_LEFT_B_PIN | BEHIND_RIGHT_F_PIN | BEHIND_RIGHT_B_PIN;
